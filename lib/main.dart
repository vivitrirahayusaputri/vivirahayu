...
class MyApp extends StatelessWidget {
  final List<Mahasiswa> daftarMahasiswa = [
    Mahasiswa(
      nama: 'Vivi Tri Rahayu Saputri',
      nim: 'STI202102318',
      prodi: 'Teknik Informatika',
      alamat: 'Jl. Baturraden Timur, Sumbang',
      email: 'vivitrirahayusaputri@gmail.com',
      noHp: '085786621767',
      foto: 'img/vivi.jpg',
    ),
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        backgroundColor: const Color.fromARGB(
            255, 255, 71, 132), // Ubah warna latar belakang menjadi pink
